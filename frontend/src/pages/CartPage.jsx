      ...
      {cartItems.length === 0 ? (
        ...
        <div className="max-w-4xl mx-auto bg-white p-6 rounded-lg shadow-md">
          {cartItems.map((item) => (
            <div
              key={item.id}
              className="fles items-center justify-between mb-4"
            >
          ...
          <div className="border-t pt-4 mt-4 flex justify-between items-center">
            ...
            <Link to="/checkout" className="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition duration-300">
              Proceed to Checkout
            </Link>
          </div>
        </div>
